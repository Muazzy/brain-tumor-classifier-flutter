...
class _DetectorPageState extends State<DetectorPage> {
  ...
  Future loadModel() async {
    await Tflite.loadModel(
      ...
      labels: 'assets/tumor_labels.txt',
    );
  }
  ...
  Future detectImage(File image) async {
    ...
    setState(() {
      ...
      try {
        if (_output != null) {
          _confidence = _output![0]["confidence"];
...
String getConfidenceString(double confidence) {
  if (confidence == 0.0) {
    return "";
  }
  ...
  confidence = confidence.floorToDouble();

  return "With confidence of $confidence%";
}
